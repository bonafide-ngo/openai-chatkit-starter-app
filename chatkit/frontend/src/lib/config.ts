...
export type UsageUiLabels = {
  usage: string;
  description: string;
  sharedBilling: string;
  tokensByMonth: string;
  billing: string;
  resetNotice: string;
  loading: string;
  unavailable: string;
...
export const USAGE_UI_LABELS: Record<string, UsageUiLabels> = {
  en: { usage: "Usage", description: "Your monthly AI usage overview.", sharedBilling: "Share monthly usage", tokensByMonth: "Your consumption by month", billing: "Billing", resetNotice: "Shared billing usage resets at the start of next month.", loading: "Loading usage...", unavailable: "Usage data is unavailable.", tokens: "Tokens" },
  de: { usage: "Nutzung", description: "Ihre monatliche Übersicht der KI-Nutzung.", sharedBilling: "Monatliche Nutzung teilen", tokensByMonth: "Ihr Verbrauch pro Monat", billing: "Abrechnung", resetNotice: "Die gemeinsame Abrechnung wird am Anfang des nächsten Monats zurückgesetzt.", loading: "Nutzung wird geladen...", unavailable: "Nutzungsdaten sind nicht verfügbar.", tokens: "Token" },
  es: { usage: "Uso", description: "Resumen mensual de tu uso de IA.", sharedBilling: "Compartir el uso mensual", tokensByMonth: "Tu consumo por mes", billing: "Facturación", resetNotice: "El uso de facturación compartida se restablece al comienzo del próximo mes.", loading: "Cargando uso...", unavailable: "Los datos de uso no están disponibles.", tokens: "Tokens" },
  fr: { usage: "Utilisation", description: "Votre aperçu mensuel de l'utilisation de l'IA.", sharedBilling: "Partager l'utilisation mensuelle", tokensByMonth: "Votre consommation par mois", billing: "Facturation", resetNotice: "La facturation partagée est réinitialisée au début du mois prochain.", loading: "Chargement de l'utilisation...", unavailable: "Les données d'utilisation sont indisponibles.", tokens: "Jetons" },
  it: { usage: "Utilizzo", description: "Riepilogo mensile del tuo utilizzo dell'IA.", sharedBilling: "Condividi l'utilizzo mensile", tokensByMonth: "Il tuo consumo per mese", billing: "Fatturazione", resetNotice: "L'utilizzo della fatturazione condivisa si azzera all'inizio del prossimo mese.", loading: "Caricamento utilizzo...", unavailable: "I dati di utilizzo non sono disponibili.", tokens: "Token" },
  ja: { usage: "使用状況", description: "毎月のAI使用状況です。", sharedBilling: "月間使用量を共有", tokensByMonth: "月別の消費量", billing: "請求額", resetNotice: "共有請求の使用量は翌月の初めにリセットされます。", loading: "使用状況を読み込み中...", unavailable: "使用状況を取得できません。", tokens: "トークン" },
  ko: { usage: "사용량", description: "월간 AI 사용량 요약입니다.", sharedBilling: "월간 사용량 공유", tokensByMonth: "월별 사용량", billing: "청구액", resetNotice: "공유 청구 사용량은 다음 달 초에 재설정됩니다.", loading: "사용량을 불러오는 중...", unavailable: "사용량 데이터를 사용할 수 없습니다.", tokens: "토큰" },
  nl: { usage: "Gebruik", description: "Uw maandelijks overzicht van AI-gebruik.", sharedBilling: "Maandelijks gebruik delen", tokensByMonth: "Uw verbruik per maand", billing: "Facturering", resetNotice: "Het gebruik van gedeelde facturering wordt aan het begin van volgende maand gereset.", loading: "Gebruik laden...", unavailable: "Gebruiksgegevens zijn niet beschikbaar.", tokens: "Tokens" },
  pl: { usage: "Wykorzystanie", description: "Miesięczne podsumowanie korzystania z AI.", sharedBilling: "Udostępnione miesięczne wykorzystanie", tokensByMonth: "Twoje zużycie w podziale na miesiące", billing: "Rozliczenie", resetNotice: "Wykorzystanie wspólnego rozliczenia zostanie zresetowane na początku przyszłego miesiąca.", loading: "Ładowanie wykorzystania...", unavailable: "Dane o wykorzystaniu są niedostępne.", tokens: "Tokeny" },
  pt: { usage: "Uso", description: "Resumo mensal do seu uso de IA.", sharedBilling: "Compartilhar uso mensal", tokensByMonth: "Seu consumo por mês", billing: "Faturamento", resetNotice: "O uso do faturamento compartilhado será redefinido no início do próximo mês.", loading: "Carregando uso...", unavailable: "Os dados de uso não estão disponíveis.", tokens: "Tokens" },
  ru: { usage: "Использование", description: "Обзор вашего месячного использования ИИ.", sharedBilling: "Общее месячное использование", tokensByMonth: "Ваше потребление по месяцам", billing: "Расходы", resetNotice: "Общее использование сбрасывается в начале следующего месяца.", loading: "Загрузка данных...", unavailable: "Данные об использовании недоступны.", tokens: "Токены" },
  zh: { usage: "使用情况", description: "您的每月 AI 使用概览。", sharedBilling: "共享每月使用量", tokensByMonth: "您的每月消耗", billing: "账单", resetNotice: "共享账单使用量将在下月初重置。", loading: "正在加载使用情况...", unavailable: "使用数据不可用。", tokens: "令牌" },
};

export const USAGE_LABELS = USAGE_UI_LABELS[CHATKIT_LOCALE] ?? USAGE_UI_LABELS.en;
...
export const EXPORT_LABELS: Record<string, {
  ...
  en: { exportChat: "Export", exportPdf: "PDF", exportDocx: "DOCX", exportTxt: "TXT", exportFailed: "Unable to export chat." },
  de: { exportChat: "Exportieren", exportPdf: "PDF", exportDocx: "DOCX", exportTxt: "TXT", exportFailed: "Chat konnte nicht exportiert werden." },
  es: { exportChat: "Exportar", exportPdf: "PDF", exportDocx: "DOCX", exportTxt: "TXT", exportFailed: "No se pudo exportar el chat." },
  fr: { exportChat: "Exporter", exportPdf: "PDF", exportDocx: "DOCX", exportTxt: "TXT", exportFailed: "Impossible d'exporter la conversation." },
  it: { exportChat: "Esporta", exportPdf: "PDF", exportDocx: "DOCX", exportTxt: "TXT", exportFailed: "Impossibile esportare la conversazione." },
  ja: { exportChat: "エクスポート", exportPdf: "PDF", exportDocx: "DOCX", exportTxt: "TXT", exportFailed: "会話をエクスポートできません。" },
  ko: { exportChat: "내보내기", exportPdf: "PDF", exportDocx: "DOCX", exportTxt: "TXT", exportFailed: "대화를 내보낼 수 없습니다." },
  nl: { exportChat: "Exporteren", exportPdf: "PDF", exportDocx: "DOCX", exportTxt: "TXT", exportFailed: "Kan gesprek niet exporteren." },
  pl: { exportChat: "Eksportuj", exportPdf: "PDF", exportDocx: "DOCX", exportTxt: "TXT", exportFailed: "Nie można wyeksportować rozmowy." },
  pt: { exportChat: "Exportar", exportPdf: "PDF", exportDocx: "DOCX", exportTxt: "TXT", exportFailed: "Não foi possível exportar a conversa." },
  ru: { exportChat: "Экспорт", exportPdf: "PDF", exportDocx: "DOCX", exportTxt: "TXT", exportFailed: "Не удалось экспортировать разговор." },
  zh: { exportChat: "导出", exportPdf: "PDF", exportDocx: "DOCX", exportTxt: "TXT", exportFailed: "无法导出对话。" },
};
