...
export const USAGE_UI_LABELS: Record<string, UsageUiLabels> = {
  en: { usage: "Usage", description: "Your monthly AI usage overview.", sharedBilling: "Share monthly usage", tokensByMonth: "Your consumption by month", resetNotice: "Shared billing usage resets at the start of next month.", loading: "Loading usage...", unavailable: "Usage data is unavailable.", tokens: "tokens" },
  de: { usage: "Nutzung", description: "Ihre monatliche Übersicht der KI-Nutzung.", sharedBilling: "Monatliche Nutzung teilen", tokensByMonth: "Ihr Verbrauch pro Monat", resetNotice: "Die gemeinsame Abrechnung wird am Anfang des nächsten Monats zurückgesetzt.", loading: "Nutzung wird geladen...", unavailable: "Nutzungsdaten sind nicht verfügbar.", tokens: "Token" },
  es: { usage: "Uso", description: "Resumen mensual de tu uso de IA.", sharedBilling: "Compartir el uso mensual", tokensByMonth: "Tu consumo por mes", resetNotice: "El uso de facturación compartida se restablece al comienzo del próximo mes.", loading: "Cargando uso...", unavailable: "Los datos de uso no están disponibles.", tokens: "tokens" },
  fr: { usage: "Utilisation", description: "Votre aperçu mensuel de l'utilisation de l'IA.", sharedBilling: "Partager l'utilisation mensuelle", tokensByMonth: "Votre consommation par mois", resetNotice: "La facturation partagée est réinitialisée au début du mois prochain.", loading: "Chargement de l'utilisation...", unavailable: "Les données d'utilisation sont indisponibles.", tokens: "jetons" },
  it: { usage: "Utilizzo", description: "Riepilogo mensile del tuo utilizzo dell'IA.", sharedBilling: "Condividi l'utilizzo mensile", tokensByMonth: "Il tuo consumo per mese", resetNotice: "L'utilizzo della fatturazione condivisa si azzera all'inizio del prossimo mese.", loading: "Caricamento utilizzo...", unavailable: "I dati di utilizzo non sono disponibili.", tokens: "token" },
  ja: { usage: "使用状況", description: "毎月のAI使用状況です。", sharedBilling: "月間使用量を共有", tokensByMonth: "月別の消費量", resetNotice: "共有請求の使用量は翌月の初めにリセットされます。", loading: "使用状況を読み込み中...", unavailable: "使用状況を取得できません。", tokens: "トークン" },
  ko: { usage: "사용량", description: "월간 AI 사용량 요약입니다.", sharedBilling: "월간 사용량 공유", tokensByMonth: "월별 사용량", resetNotice: "공유 청구 사용량은 다음 달 초에 재설정됩니다.", loading: "사용량을 불러오는 중...", unavailable: "사용량 데이터를 사용할 수 없습니다.", tokens: "토큰" },
  nl: { usage: "Gebruik", description: "Uw maandelijks overzicht van AI-gebruik.", sharedBilling: "Maandelijks gebruik delen", tokensByMonth: "Uw verbruik per maand", resetNotice: "Het gebruik van gedeelde facturering wordt aan het begin van volgende maand gereset.", loading: "Gebruik laden...", unavailable: "Gebruiksgegevens zijn niet beschikbaar.", tokens: "tokens" },
  pl: { usage: "Wykorzystanie", description: "Miesięczne podsumowanie korzystania z AI.", sharedBilling: "Udostępnione miesięczne wykorzystanie", tokensByMonth: "Twoje zużycie w podziale na miesiące", resetNotice: "Wykorzystanie wspólnego rozliczenia zostanie zresetowane na początku przyszłego miesiąca.", loading: "Ładowanie wykorzystania...", unavailable: "Dane o wykorzystaniu są niedostępne.", tokens: "tokenów" },
  pt: { usage: "Uso", description: "Resumo mensal do seu uso de IA.", sharedBilling: "Compartilhar uso mensal", tokensByMonth: "Seu consumo por mês", resetNotice: "O uso do faturamento compartilhado será redefinido no início do próximo mês.", loading: "Carregando uso...", unavailable: "Os dados de uso não estão disponíveis.", tokens: "tokens" },
  ru: { usage: "Использование", description: "Обзор вашего месячного использования ИИ.", sharedBilling: "Общее месячное использование", tokensByMonth: "Ваше потребление по месяцам", resetNotice: "Общее использование сбрасывается в начале следующего месяца.", loading: "Загрузка данных...", unavailable: "Данные об использовании недоступны.", tokens: "токенов" },
  zh: { usage: "使用情况", description: "您的每月 AI 使用概览。", sharedBilling: "共享每月使用量", tokensByMonth: "您的每月消耗", resetNotice: "共享账单使用量将在下月初重置。", loading: "正在加载使用情况...", unavailable: "使用数据不可用。", tokens: "令牌" },
};
